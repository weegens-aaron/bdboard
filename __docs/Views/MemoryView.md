...
| `GET /api/events` | The shared SSE subscription (in `base.html`) that fires `refresh from:body` so the list stays live across tabs. | [GET /api/events](../Endpoints/GetApiEvents.md) |
