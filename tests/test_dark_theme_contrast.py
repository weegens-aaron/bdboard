...
CASES = [
    ...
    ("var(--muted)", "var(--paper-3)", AA_NORMAL, "contents-bar inactive link"),
    ("var(--ink)", "var(--paper-3)", AA_NORMAL, "contents-bar active link"),
    ("var(--brand-blue)", "var(--paper-3)", AA_LARGE, "active baseline rule (UI)"),
