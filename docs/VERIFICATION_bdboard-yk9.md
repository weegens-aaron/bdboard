...
- Zero-count cells use de-emphasized colors:
  ...
  - Label: `var(--muted)` = `#74767c` (4.54:1 contrast on white)
- De-emphasis is color-only (no `display:none` or layout removal)
- **WCAG 2.2 AA compliant**: Both label and value meet requirements
...
- ✅ Zero-count label (#74767c) meets WCAG AA for small text (4.54:1 ≥ 4.5:1)
- ✅ Populated count value (#2e2f32) exceeds WCAG AAA (13.39:1 ≥ 7:1)
...
- **Populated counts**: #2e2f32 on white = **13.39:1** ✅ (exceeds 3:1 requirement, also AAA)

### Small Text (10px label)  
- **Zero count labels**: #74767c on white = **4.54:1** ✅ (meets 4.5:1 requirement)
- **Populated count labels**: #2e2f32 on white = **13.39:1** ✅ (exceeds 4.5:1 requirement)

**All text elements meet or exceed WCAG 2.2 AA requirements** in both zero and populated states.
