...
> Seeded stub. Fill from `_template.md`. Owner bead: bdboard-6ljg.
> Field-guide chapter: `field-guide-07-swarms.html` (chapter 7).
...
| Primary sources  | `templates/partials/field_row.html`, `bead_modal.html`; `src/bdboard/bd.py`; `docs/catalog/bead-modal.md`                                      |
| Status           | `not-started`                                  |
...
_TODO (bdboard-6ljg): summarize the bd 1.0.4 feature surface for this area, citing
`field-guide-07-swarms.html` § "<section>"._

## 2. REFLECTED — what bdboard actually displays

_TODO (bdboard-6ljg): what bdboard SHOWS the user, with `file:line` citations into
