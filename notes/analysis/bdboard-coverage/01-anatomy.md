...
> Seeded stub. Fill from `_template.md`. Owner bead: bdboard-cnzi.
> Field-guide chapter: `field-guide-01-anatomy-of-a-bead.html` (chapter 1).
...
| Primary sources  | `templates/partials/field_row.html`, `bead_modal.html`, `bead_card.html`; `src/bdboard/bd.py`; `docs/catalog/bead-modal.md`                                      |
| Status           | `not-started`                                  |
...
_TODO (bdboard-cnzi): summarize the bd 1.0.4 feature surface for this area, citing
`field-guide-01-anatomy-of-a-bead.html` § "<section>"._

## 2. REFLECTED — what bdboard actually displays

_TODO (bdboard-cnzi): what bdboard SHOWS the user, with `file:line` citations into
