...
> Seeded stub. Fill from `_template.md`. Owner bead: bdboard-vhke.
> Field-guide chapter: `field-guide-02-dependency-graph.html` (chapter 2).
...
| Primary sources  | `src/bdboard/derive/lanes.py`; `templates/partials/field_row.html`, `bead_modal.html`; `docs/catalog/bead-modal.md`                                      |
| Status           | `not-started`                                  |
...
_TODO (bdboard-vhke): summarize the bd 1.0.4 feature surface for this area, citing
`field-guide-02-dependency-graph.html` § "<section>"._

## 2. REFLECTED — what bdboard actually displays

_TODO (bdboard-vhke): what bdboard SHOWS the user, with `file:line` citations into
