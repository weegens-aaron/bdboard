...
> Seeded stub. Fill from `_template.md`. Owner bead: bdboard-2w9b.
> Field-guide chapter: `field-guide-03-status-lifecycle.html` (chapter 3).
...
| Primary sources  | `src/bdboard/derive/lanes.py`; `templates/partials/lanes.html`, `closed_lane.html`, `counts.html`; `docs/catalog/board-lanes.md`                                      |
| Status           | `not-started`                                  |
...
_TODO (bdboard-2w9b): summarize the bd 1.0.4 feature surface for this area, citing
`field-guide-03-status-lifecycle.html` § "<section>"._

## 2. REFLECTED — what bdboard actually displays

_TODO (bdboard-2w9b): what bdboard SHOWS the user, with `file:line` citations into
